...
export function CourseDetailsModal(props: CourseDetailsModalProps) {
    const [local, others] = splitProps(props, ["course", "open", "onOpenChange"]);
                    ...
                    <DialogContent class="max-w-2xl max-h-[80vh] overflow-y-auto">
                        ...
                        <div class="space-y-6">
                            ...
                            <div class="space-y-3">
                                ...
                                <h2 class="text-xl font-semibold">{course().courseTitle}</h2>
                                <p class="text-muted-foreground">{course().subjectDescription}</p>
                            </div>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div class="space-y-3">
                                    ...
                                    <div class="flex items-center gap-2">
                                        ...
                                        <span>
                                            {course().enrollment}/{course().maximumEnrollment}
                                        </span>
                                    </div>
                                    ...
                                    <Show when={course().waitCapacity > 0}>
                                        <div class="flex items-center gap-2">
                                            ...
                                            <span>
                                                ...
                                                {course().waitAvailable} available)
                                            </span>
                                        </div>
                                    </Show>
                                </div>
                                ...
                                <div class="space-y-3">
                                    <div class="flex items-center gap-2">
                                        ...
                                        <span>{course().campusDescription}</span>
                                    </div>

                                    <div class="flex items-center gap-2">
                                        <BookOpen class="h-4 w-4 text-muted-foreground" />
                                        <span class="font-medium">Method:</span>
                                        <span>{course().instructionalMethodDescription}</span>
                                    </div>

                                    <div class="flex items-center gap-2">
                                        <Calendar class="h-4 w-4 text-muted-foreground" />
                                        <span class="font-medium">Term:</span>
                                        <span>{course().termDesc}</span>
                                    </div>
                                </div>
                            </div>
